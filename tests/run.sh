...
for index in "${!test_files[@]}"; do
  ...
  if env \
    ...
    -u ROLE_TERMINAL -u ROLE_TERMINAL_PACKAGES -u ROLE_MULTIPLEXER -u ROLE_MULTIPLEXER_PACKAGES \
    -u ROLE_FILE_MANAGER -u ROLE_FILE_MANAGER_PACKAGES \
    -u ROLE_TUI_FILE_MANAGER -u ROLE_TUI_FILE_MANAGER_PACKAGES \
    -u ROLE_NOTIFICATIONS -u ROLE_NOTIFICATIONS_PACKAGES \
