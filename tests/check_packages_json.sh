  ...
  def role_policy:
    {
      ...
      file_manager: ["single", true, "dolphin"],
      tui_file_manager: ["multiple", false, null],
  ...
  def expected_options:
    {
      ...
      file_manager: ["dolphin", "nautilus", "nemo", "pcmanfm-qt", "thunar"],
      tui_file_manager: ["lf", "mc", "nnn", "ranger", "vifm", "yazi"],
