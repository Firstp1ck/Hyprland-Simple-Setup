...
alias update-ollama='Start_System_setup.sh -f configure_ollama'
alias stows='Start_stow_solve.sh'
alias note='notes.sh'
alias notes='notes.sh'
alias pihole='Start_pihole_check.sh'
alias tnotify='Start_notify_test.sh'
alias python-cert-debug='Start_System_setup.sh --function debug_python_certificates'
alias update-sha='update-sha256sums.sh'
