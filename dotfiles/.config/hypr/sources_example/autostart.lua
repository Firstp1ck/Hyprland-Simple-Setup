...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("sleep 1; " .. apps.hyprscripts .. "/role_exec.sh bar") -- hss-role:bar-autostart
    -- hl.exec_cmd("sleep 1; " .. apps.hyprscripts .. "/role_exec.sh dock") -- hss-role:dock-autostart
    hl.exec_cmd("sleep 1; " .. apps.hyprscripts .. "/role_exec.sh notifications") -- hss-role:notification-autostart
    hl.exec_cmd("sleep 1; " .. apps.hyprscripts .. "/Startup_check.sh")

    hl.exec_cmd(apps.editor, { workspace = "1 silent" }) -- hss-role:gui-editor-autostart
    ...
    -- Optional non-role extras. setup.sh enables these only when their dependencies exist.
    -- hl.exec_cmd("pypr")
